...
function ProjectSwitcher({
  ...
  return (
    ...
    >
      ...
      {/* Project list — empty state matters: no fake projects to hide behind */}
      {projects.length === 0 ? (
        ...
        <div style={{ position: 'relative' }}>
          <motion.button
            ...
            style={{
              ...
              background: projectsOpen
                ? `${activeProject?.accent_color ?? '#ff3c00'}18`
                : hoveredId === 'projects'
                ? 'rgba(255,255,255,0.06)'
                : 'transparent',
          ...
          >
            ...
            <FolderOpen
              ...
              strokeWidth={1.5}
              color={projectsOpen
                ? (activeProject?.accent_color ?? '#ff3c00')
                : hoveredId === 'projects'
            ...
            >
              <ChevronUp
                size={8}
                color={projectsOpen ? (activeProject?.accent_color ?? '#ff3c00') : 'rgba(240,236,228,0.25)'}
              />
            </motion.div>
          </motion.button>
