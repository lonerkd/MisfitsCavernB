    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)', color: 'var(--fg)', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
        ...
        <EditorSidePanels
          ...
          sceneTypeColor={sceneTypeColor}
          sceneWordCounts={sceneWordCounts}
          sceneCharMap={sceneCharMap}
          insertElement={insertElement}
          sprintActive={sprintActive}
          onToggleSprint={() => setSprintActive(!sprintActive)}
          ...
          nightModePreview={nightModePreview}
          onNightModePreviewChange={setNightModePreview}
          elements={elements}
          ...
          onViewDiff={(revisionId) => { setDiffRevisionId(revisionId); setShowDiff(true); }}
          showSceneNumbers={showSceneNumbers}
          onShowSceneNumbersChange={setShowSceneNumbers}
          ...
          onInsertStash={(text) => {
            spEditorRef.current?.insertText(text);
