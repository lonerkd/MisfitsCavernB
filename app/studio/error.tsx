  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg)', color: 'var(--fg)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 16, padding: 32 }}>
      ...
      <div style={{ display: 'flex', gap: 12, marginTop: 8 }}>
        ...
        <button onClick={() => window.location.href = '/projects'} style={{ padding: '10px 24px', background: 'transparent', color: 'var(--fg)', border: '1px solid rgba(255,255,255,0.15)', borderRadius: 6, fontFamily: 'var(--mono)', fontSize: 10, letterSpacing: 2, cursor: 'pointer', textDecoration: 'none' }}>BACK TO PROJECTS</button>
      </div>
    </div>
  );
}